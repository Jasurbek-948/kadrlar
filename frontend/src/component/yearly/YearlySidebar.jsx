        ...
        >
          <nav className="menu">
            <ul className="space-y-2">
              ...
              >
                <Link to="/choraklik-hisobotlar" className="flex items-center p-2">
                  <FontAwesomeIcon className="mr-3 text-lg" icon={faCalendar} />
                  <span>Milliy tarkib</span>
                </Link>
              </li>
              <li
              ...
              >
                <Link to="/choraklik-hisobotlar/klassifikator" className="flex items-center p-2">
...
export default MonthlySidebar; // Default eksport
